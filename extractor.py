...
class BasicEncoder(nn.Module):
    def __init__(self, output_dim=128, norm_fn='instance', dropout=0.0):
        ...
        self.out_conv1 = nn.Conv2d(32, output_dim, kernel_size=1)
        self.out_conv2 = nn.Conv2d(48, output_dim, kernel_size=1)
        self.out_conv3 = nn.Conv2d(64, output_dim, kernel_size=1)      
